...
export class StartMenuHandler {
    ...
    static async showStartMenu(interactionOrMessage, gameState) {
        try {
                ...
                .addOptions([
                    {
                        ...
                        description: 'Begin your journey in the dungeon',
                        value: 'start_game',
                        emoji: '⚔️'
                    },
                    {
                    ...
                    {
                        label: 'Daily Quests',
                        description: 'View and manage your daily quests',
                        value: 'daily_quests',
                        emoji: '📜'
                    },
                    {
                    ...
                    {
                        label: 'Leaderboard',
                        description: 'Check the top players',
                        value: 'leaderboard',
                        emoji: '🏆'
                    },
                    {
                        label: 'Exchange',
                        description: 'Exchange currencies (1000:1 ratio)',
                        value: 'exchange_menu',
                        emoji: '🔄'
                    },
                    {
                        label: 'Wallet Loader',
                        description: 'Load your wallet balance',
                        value: 'wallet_loader',
                        emoji: '💳'
                    }
                ]);
            ...
            // Set screen and update activity
        ...
        try {
            const tutorialEmbed = new EmbedBuilder()
                ...
                .setDescription('**How to Play:**\n\n' +
                    ...
                    '🚫 **Important Rules:**\n' +
                    '• NO experience points or leveling system\n' +
                    '• NO timer delays after selections\n' +
                    '• String menus only (no buttons)\n' +
                    '• All embeds are replies (except exploration updates)')
                .setColor(0x4169E1)
                .setFooter({ text: 'Good luck in the dungeon, hero!' })
                .setTimestamp();
            ...
            logger.info(`Tutorial displayed for user ${interaction.user.id}`);
